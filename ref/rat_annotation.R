...
setwd("/camp/lab/luscomben/home/users/chakraa2/projects/flora/ref/rat")
...
# Load annotation
genes.gr <- import.gff2("Rn_Ens100_Q_v3.10k_0.01score.extended.gtf.gz")
...
genes.gr$gene_type <- genes.gr$gene_biotype # Ensembl v Gencode
...
ref.fasta <- "Rattus_norvegicus.Rnor_6.0.dna.toplevel.fa"
...
cmd <- paste("bedtools getfasta -s -name -fi", masked.fasta, "-bed", reduced.sel.genes.bed, "| pigz > rat_Ens100_Q_v3.10k_0.01score.fa.gz")
message(cmd)
system(cmd)
...
export.gff2(transcript.gtf, "rat_Ens100_Q_v3.10k_0.01score.gtf")
system("pigz rat_Ens100_Q_v3.10k_0.01score.gtf")